#!/bin/bash
# Script de inicio para OpenLDAP con configuracion de usuarios SSH heredada
set -e

# Cargar funciones de configuracion base (usuarios y SSH)
...
main(){
    ...
    # Gestion de usuario heredada de ubbase
    set +e
    newUser
    resuser=$?
    set -e
    ...
    # Iniciar OpenLDAP
    echo "INFO: Iniciando servidor OpenLDAP..." >> /root/logs/informe.log
    mkdir -p /run/sshd
    
    # Iniciar slapd en segundo plano
    service slapd start
